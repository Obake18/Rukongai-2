...
const caso3 = new Caso("Sussurros Sangrentos em Kyoto", "Kyoto", "Kazuki Yamamoto", "Kazuki Yamamoto foi encontrado em seu quarto, com mensagens sangrentas escritas nas paredes. Testemunhas afirmam ter ouvido sussurros assustadores na noite anterior ao ocorrido.", "22/09/2002", "Nunca resolvido, o quarto permanece selado por causa das atividades paranormais.", "Kuchisake-onna");

const caso4 = new Caso("Pesadelos Profundos em Sapporo", "Sapporo", "Sakura Kobayashi", "Sakura Kobayashi experimentou uma série de pesadelos horríveis antes de sua morte. Seu corpo foi descoberto em um templo abandonado, com marcas de mãos sangrentas em seu pescoço.", "04/07/1977", "A polícia alegou suicídio, mas moradores locais acreditam que foi obra de um espírito vingativo.", "Onryo");

const caso5 = new Caso("Máscara Maldita em Nara", "Nara", "Takeshi Sato", "Takeshi Sato encontrou uma máscara assombrada em uma loja de antiguidades. Após colocá-la, ele começou a agir de maneira estranha, e testemunhas relataram ouvir vozes sussurrantes quando estavam perto dele.", "15/11/1999", "Morto durante um exorcismo mal-sucedido, a máscara permanece amaldiçoada.", "Noh Mask");

const caso6 = new Caso("Garras na Escuridão em Fukuoka", "Fukuoka", "Haruka Ito", "Haruka Ito foi encontrada morta em um beco escuro, com marcas de garras profundas em seu corpo. Testemunhas relatam ter visto uma figura sombria nas proximidades na noite anterior.", "30/05/2010", "Caso sem resolução, os moradores evitam o beco à noite.", "Kawa-no-kami");

const caso7 = new Caso("Pendurado por Inscrições em Osaka", "Osaka", "Tomo Tanaka", "Tomo Tanaka desapareceu depois de visitar um santuário assombrado. Seu corpo foi descoberto pendurado em uma árvore próxima, com inscrições estranhas nas mãos.", "10/12/1989", "Considerado um suicídio, mas moradores locais acreditam em uma maldição do santuário.", "Jibakurei");

const caso8 = new Caso("Elevador Macabro em Tokyo", "Tokyo", "Yuki Suzuki", "Yuki Suzuki foi encontrada morta em um elevador antigo. Câmeras de segurança mostram a porta do elevador abrindo e fechando sozinha antes de sua morte.", "05/02/2005", "Oficialmente considerado um acidente, mas rumores de atividade paranormal persistem no prédio.", "Aka Manto");
